...
from src.components.dailog_share_subject import share_subject_dialog
...
def teacher_tab_take_attendance():
    ...
    if not subjects:
        st.warning('You havent create any subjects yet! Please create one to begin!')
        return
...
def teacher_screen_register():
    ...
    st.markdown(
    "<h2 style='text-align:center; white-space:nowrap;'>Register your teacher profile</h2>",
